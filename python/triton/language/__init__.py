...
def str_to_ty(name, c):
    ...
    if name.startswith("tensordesc"):
        ...
        # For im2col, parse optional input_rank=N and convolution metadata.
        tensor_rank = None
        im2col_metadata = {}
        import ast as _ast
        import re as _re
        ...
        for _name in ("conv_filter_shape", "element_strides", "pixel_box_lower_corner", "pixel_box_upper_corner"):
        ...
        if is_gluon:
            ...
            if isinstance(layout, NVMMASharedLayout):
                if is_im2col:
                    return nvidia_tensor_descriptor_im2col_type(
                        block, shape_type, stride_type, layout, **im2col_metadata)
